...
portal_targeter.base_picture =
{
	...
	{
		{
			filename = "__Teleportation_Redux__/graphics/portal-64.png",
			line_length = 1,
			width = 64,
			height = 64,
			frame_count = 1,
...
data:extend({
  {
    ...
    {
      {
        filename = "__Teleportation_Redux__/graphics/empty.png",
        priority = "extra-high",
        width = 33,
        height = 32,
        frame_count = 1,
...
if settings.startup["Teleportation-telelogistics-enabled"].value then
  ...
  teleprovider.picture = {
    filename = "__Teleportation_Redux__/graphics/teleprovider-entity.png",
    priority = "extra-high",
    width = 38,
    height = 32,
    shift = {0.09375, 0}
